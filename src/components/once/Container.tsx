...
const Container = ({ title, buttonText }: Props) => {
    return (
        ...
        >
            ...
            <WrapperContainer>
                <div data-aos="fade-right" className="relative z-10 flex flex-col justify-between px-8 md:px-16">
                    <h2 data-aos="fade-right" className="text-2xl md:text-3xl font-bold text-white">
                        {title}
                    </h2>
