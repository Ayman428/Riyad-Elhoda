...
const EqualityValues: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white p-4 flex flex-col justify-center items-center" dir={isRTL ? 'rtl' : 'ltr'}>
      {/* Background circles */}
        ...
        <div className="flex flex-col lg:flex-row-reverse justify-between  items-center gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full lg:w-1/2">
            ...
            <div data-aos="fade-up" className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-blue-900 font-bold mb-1">{t('equality:creativityTitle')}</h3>
              <p className="text-gray-500 text-sm">{t('equality:creativitySubtext')}</p>
            </div>
            ...
            <div data-aos="fade-up" className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-blue-900 font-bold mb-1">{t('equality:islamicValuesTitle')}</h3>
              <p className="text-gray-500 text-sm">{t('equality:islamicValuesSubtext')}</p>
            </div>
            ...
            <div data-aos="fade-up" className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-blue-900 font-bold mb-1">{t('equality:developmentTitle')}</h3>
              <p className="text-gray-500 text-sm">{t('equality:developmentSubtext')}</p>
            </div>
            ...
            <div data-aos="fade-up" className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-blue-900 font-bold mb-1">{t('equality:excellenceTitle')}</h3>
              <p className="text-gray-500 text-sm">{t('equality:excellenceSubtext')}</p>
            </div>
          </div>
          
          {/* Right side - text */}
          <div className={`w-full lg:w-1/2 ${isRTL ? 'text-right' : 'text-left'} font-bold`}>
